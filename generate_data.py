...
def get_dota():
    ...
    for h in data:
        heroes.append({
            "en": h["localized_name"],
            "ru": h["localized_name"]  # RU версии нет в API → дублируем
        })
...
# -------------------------
# 🔫 BRAWL STARS (fallback list)
# -------------------------
def get_brawl():
    # Supercell API нестабилен без ключа → используем полный актуальный список вручную
    # (это единственный реальный способ без ключа)
    return [
        {"en": "Shelly", "ru": "Шелли"},
        {"en": "Colt", "ru": "Кольт"},
        {"en": "Bull", "ru": "Булл"},
        ...
        {"en": "Crow", "ru": "Кроу"},
        {"en": "Mortis", "ru": "Мортис"},
        {"en": "El Primo", "ru": "Эль Примо"},
        {"en": "Jessie", "ru": "Джесси"},
        {"en": "Nita", "ru": "Нита"},
        {"en": "Poco", "ru": "Поко"},
        {"en": "Barley", "ru": "Барли"},
        {"en": "Dynamike", "ru": "Динамайк"},
        {"en": "Piper", "ru": "Пайпер"},
        {"en": "Pam", "ru": "Пэм"},
        {"en": "Frank", "ru": "Фрэнк"},
        {"en": "Bibi", "ru": "Биби"},
...
def build():
    result = {
        "dota": {"heroes": get_dota()},
        "brawl": {"heroes": get_brawl()},
        "clash": {"heroes": get_clash()}
    }

    with open("data.json", "w", encoding="utf-8") as f:
        json.dump(result, f, ensure_ascii=False, indent=2)

    print("✅ data.json создан и обновлён")
